...
# Navigate to directory where Train_YOLOv11.py is located.
...
save_directory = os.path.expanduser("~/Desktop/YOLOv11_Models+Results/Model_13")  
...
model = YOLO('yolo11s.pt') # Load pretrained YOLOv11 model
...
results = model.train(
    ...
    ############ Model name ############
    name="Plastic_identifier_YOLOv11_13"  # CHANGE NAME 
)
